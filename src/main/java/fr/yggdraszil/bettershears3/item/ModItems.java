...
public class ModItems
{
    ...
    public static final RegistryObject<Item> GOLD_SHEARS = ITEMS.register("gold_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(20).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> FLINT_SHEARS = ITEMS.register("flint_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(35).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> LAPIS_SHEARS = ITEMS.register("lapis_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(85).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> CLAY_SHEARS = ITEMS.register("clay_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(101).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> COPPER_SHEARS = ITEMS.register("copper_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(200).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> AMETHYST_SHEARS = ITEMS.register("amethyst_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(375).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> DIAMOND_SHEARS = ITEMS.register("diamond_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(1549).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> EMERALD_SHEARS = ITEMS.register("emerald_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(1979).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> OBSIDIAN_SHEARS = ITEMS.register("obsidian_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(2999).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
    public static final RegistryObject<Item> NETHERITE_SHEARS = ITEMS.register("netherite_shears",
            () -> new Item(new Item.Properties().stacksTo(1).durability(4044).tab(ModCreativeModTab.BETTERSHEARS_TAB)));
